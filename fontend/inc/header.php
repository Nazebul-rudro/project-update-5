    ...
    <header class="backgroundline col-lg-12 col-md-12 col-dm-12">
        <div class="container mt-2">
            <div class="d-flex justify-content-end align-items-center headerButton">
                ...
                <p class="px-3"><a href="category/login.php">Login</a></p>
                <p class="px-3"><a href="category/register.php">Registration</a></p>
            </div>
        </div>
    </header>
    <!-- header end -->
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item navbarAbsolute">
              <a class="nav-link" href="category/cart.php"><i class="fa-sharp fa-solid fa-cart-shopping"></i><span class="refresh">0</span> Cart</a>
            </li>          
          </ul>
      </div>
        </div>   
